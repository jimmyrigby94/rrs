...
#' @param max.x max possible value of x. Defines limits.
#' @param min.x min possible value of x. Defines limits.
#' @param max.y max possible value of y. Defines limits. 
#' @param min.y max possible value of y. Defines limits.
